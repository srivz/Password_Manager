...
class ForgotPassFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.forgotPassFrame = tk.LabelFrame(self, text="Forgot Password", bd=5, bg=self.backgroundColor,
                                             fg=self.secTextColor)
        self.forgotPassFrame.place(relx=0, rely=0, relwidth=1, relheight=1)
        self.confirmLabel = tk.Label(self.forgotPassFrame, text="Email Sent", bg=self.successColor,
                                     fg=self.priTextColor, font=self.labelFont)
        self.titleLabel = tk.Label(self.forgotPassFrame, text='Forgot Password ?', bg=self.backgroundColor,
                                   fg=self.primaryColor, font=("Rockwell", 18, "bold"))
        self.titleLabel.place(relx=0.25, rely=0.15, relheight=0.1, relwidth=0.5)
        self.emailLabel = tk.Label(self.forgotPassFrame, text='Enter registered email id', bg=self.backgroundColor,
                                   fg=self.secTextColor, font=self.labelFont)
        self.emailLabel.place(relx=0.25, rely=0.32, relheight=0.07, relwidth=0.5)
        self.emailentry = tk.Entry(self.forgotPassFrame, width=20, font=self.entryFont, bg=self.surface1Color,
                                   fg=self.secTextColor)
        ...
        self.otpLabel = tk.Label(self.forgotPassFrame, text='Enter Otp', bg=self.backgroundColor, fg=self.secTextColor,
                                 font=self.labelFont)
        self.otpLabel.place(relx=0.25, rely=0.56, relheight=0.07, relwidth=0.5)
        self.otpentry = tk.Entry(self.forgotPassFrame, width=20, font=self.entryFont, bg=self.surface1Color,
                                 fg=self.secTextColor)
        ...
        self.otpEnterButton = tk.Button(self.forgotPassFrame, text="Enter",
    ...
    def checkOTP(self):
        ...
        if (enteredOTP == self.generatedOTP):
            ...
            errorLabel = tk.Label(self.forgotPassFrame, text="OTP incorrect", bg=self.errorColor, fg=self.priTextColor,
                                  font=self.labelFont)
    ...
    def sendOtp(self):
        ...
        if (not (pdb.mailCheck(mail))):
            errorLabel = tk.Label(self.forgotPassFrame, text="Wrong Email entered", bg=self.errorColor,
                                  fg=self.priTextColor, font=self.labelFont)
            errorLabel.place(relx=0.16, rely=0.02, relwidth=0.7, relheight=0.05)
        ...
        mail = SendMail()
        subject = 'PasswordManager: Forgot Password'
        message = "Forgot your password?\n\nWe received a request to reset your password.\nTo reset yur password use the " \
                  "OTP that is below:\n" + str(self.generatedOTP) + "\nIf you did not forget your password you can " \
                                                                    "safely delete and ignore this mail.\n\nThankyou. "
